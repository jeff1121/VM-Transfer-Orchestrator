...
const sidebarPinned = ref(localStorage.getItem('app_sidebar_pinned') !== 'false')
...
const toggleSidebarPin = () => {
  ...
  localStorage.setItem('app_sidebar_pinned', String(sidebarPinned.value))
}
    ...
    <template v-else>
      ...
      >
          ...
          <div class="sidebar-brand">
            <div class="brand-badge">
              <div class="brand-logo-container">
                <img src="/logo.png" alt="Logo" class="brand-sidebar-logo" />
              </div>
        ...
        <div class="sidebar-footer">
          <div class="cluster-status-card" :title="!isSidebarExpanded ? '即時連線中' : ''">
        ...
        <header class="glass-topbar">
          <div class="topbar-left">
            ...
            <div class="breadcrumb-trail">
              <span class="breadcrumb-root">Enterprise Engine</span>
